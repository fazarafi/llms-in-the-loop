...
RESULTS_PATH = os.path.join(PATH_TO_SRC, 'data/foundation_model_selection/gpt-4-turbo-0.1-temp')
...
def repeat_annotation(n_repeat=10, **ask_gpt_kwargs):
    ...
    for i in tqdm(range(n_repeat)):
        ...
        if (ask_gpt_kwargs['model'] == 'gpt-4-1106-preview' or 
            ask_gpt_kwargs['model'] == 'gpt-4-0125-preview'):
...
gpt_annotations['overall_consistency']
