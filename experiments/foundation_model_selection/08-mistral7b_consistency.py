...
RESULTS_PATH = os.path.join(PATH_TO_SRC, 'data/foundation_model_selection/mistral-0.1-temp')
...
def ask_gpt_short(
    ...
    if model in ['gpt-4-1106-preview' , 'gpt-4-0125-preview',"llama2:70b","llama2","mistral:7b"]:  
...
def repeat_annotation(n_repeat=10, **ask_gpt_kwargs):
    ...
    for i in tqdm(range(n_repeat)):
        ...
        if ask_gpt_kwargs['model'] in ['gpt-4-1106-preview', 'gpt-4-0125-preview',"llama2:70b","llama2","mistral:7b"]:
